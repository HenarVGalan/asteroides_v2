var marcadorLocal = document.getElementById("naveLocal");
var marcadorEnemigo = document.getElementById("naveEnemiga");
...
function Juego() {
  ...
  this.create = function() {
    ...
    // Inicializamos cadena del marcador
  ...
  this.update = function() {
    ...
    if (!this.fin) {
      ...
      if (nave) {
        ...
        // Llamamos a actualizar el marcador dentro del bloque if(nave){}
  ...
  this.actualizarMarcador = function() {
    this.marcador.setText("Puntos. Yo:" + this.naveLocal.puntos + "- Rival:" + this.naveEnemiga.puntos);
    game.world.bringToTop(this.marcador);

    document.getElementById("naveLocal").innerHTML=this.naveLocal.puntos;
    document.getElementById("naveEnemiga").innerHTML=this.naveEnemiga.puntos;
  }
...
function Nave(id, x, y, veggie) {
  ...
  // Esta función se ejecuta cuando llega a la posición
